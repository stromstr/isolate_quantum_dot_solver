subroutine swapms(lmat, norbs, nspin, irowin, icolin, iorbs, ispin, &
                  irowout, icolout, isgnout)
implicit none
!
integer, intent(in)  :: lmat, norbs, nspin, iorbs, ispin, irowin, icolin
